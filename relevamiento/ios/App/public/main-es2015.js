...
const routes = [
    ...
    {
        path: 'bienvenido',
        loadChildren: () => __webpack_require__.e(/*! import() | bienvenido-bienvenido-module */ "bienvenido-bienvenido-module").then(__webpack_require__.bind(null, /*! ./bienvenido/bienvenido.module */ "./src/app/bienvenido/bienvenido.module.ts")).then(m => m.BienvenidoPageModule)
    },
    {
        path: 'login',
...
const environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyC6GOsOKzqSq-8FSwqC3qGOxCeky8ksHPM",
        authDomain: "relevamiento-cf61d.firebaseapp.com",
        databaseURL: "https://relevamiento-cf61d.firebaseio.com",
        projectId: "relevamiento-cf61d",
        storageBucket: "relevamiento-cf61d.appspot.com",
        messagingSenderId: "975504295855",
        appId: "1:975504295855:web:ec215450fc40f6c5a4115a",
        measurementId: "G-PQS6F9YLFG"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\gacosta\FACULTAD\PPS\relevamiento\relevamiento\src\main.ts */"./src/main.ts");
